...
function isEstado(val: unknown): val is Estado {
    return ["sin ver", "en proceso", "resuelto"].includes(val as string);
}
        ...
        try {
            ...
            const parsedTickets: Ticket[] = parsed
                .filter((t: unknown) => {
                    ...
                    const ticket = t as Partial<Ticket>;
                    return (
                        ...
                        {tickets.map((ticket) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    <span
                                        className={`px-3 py-1 rounded-full text-sm font-semibold ${ticket.estado === "sin ver"
                                            ? "bg-red-500"
